...
public class LancerApp1 {
	...
	public static void main(String[] args) throws IOException {
		...
		//12ème question
		d.ajouterObjet((IFormeAnimable)new PolygoneRegulier(4,255,150,20,1,new Color(220,220,220),new Color(220,220,220)),new MvtCirculaire(255,150,70,15,15));
		d.ajouterObjet((IFormeAnimable)new Etoile(255,350,30,20,new Color(255,255,0),new Color(255,255,0)),new MvtCirculaire(255,350,70,50,15));
				
		
		//19ème question
		d.ajouterObjet((IFormeAnimable) new Visage(d),new MvtCirculaire(80,80,40,100,20));
